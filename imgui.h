...
namespace ImGui
{
    ...
    IMGUI_API void          TextIcon(const char* icon, const char* text, ImU32 color);
    ...
    IMGUI_API bool          TextButton(const char* label, bool icon = true, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);

    IMGUI_API bool          tabs(bool selected, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);

    IMGUI_API bool          SubTabs(bool selected, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
